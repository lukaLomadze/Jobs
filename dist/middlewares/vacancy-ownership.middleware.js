...
exports.VacancyOwnershipMiddleware = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const role_enum_1 = require("../enum/role.enum");
let VacancyOwnershipMiddleware = class VacancyOwnershipMiddleware {
    userModel;
    vacancyModel;
    constructor(userModel, vacancyModel) {
...
exports.VacancyOwnershipMiddleware = VacancyOwnershipMiddleware;
exports.VacancyOwnershipMiddleware = VacancyOwnershipMiddleware = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('user')),
    __param(1, (0, mongoose_1.InjectModel)('vacancy')),
    __metadata("design:paramtypes", [mongoose_2.Model,
        mongoose_2.Model])
], VacancyOwnershipMiddleware);
//# sourceMappingURL=vacancy-ownership.middleware.js.map